...
RUN cd /opt && wget http://download.jboss.org/wildfly/10.1.0.Final/wildfly-10.1.0.Final.tar.gz && tar -zxvf wildfly-10.1.0.Final.tar.gz && mv /opt/wildfly-10.1.0.Final /opt/wildfly
